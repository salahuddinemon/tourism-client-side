                    ...
                    <div className="mt-8 overflow-hidden">
                        <div className="grid grid-cols-1 md:grid-cols-2">
                            ...
                            <form className="p-6 flex flex-col justify-center">
                                <h2 className="text-4xl text-purple-700	font-bold">HAVE A QUESTION?</h2>
                                <hr />
                                ...
                                <div className="flex flex-col mt-2">
                                    ...
                                    <input type="tel" name="tel" id="tel" placeholder="Your Number" className="w-100 mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 font-semibold focus:border-indigo-500 focus:outline-none" />
                                </div>
                                <div className="flex flex-col mt-2">
                                    <label htmlFor="tel" className="hidden">Comments</label>
                                    <textarea type="text" name="text" id="text" placeholder="Your comments" className="w-100 mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 font-semibold focus:border-indigo-500 focus:outline-none" />
                                </div>
